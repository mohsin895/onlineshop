...
//Paypal Page
// Route::get('/paypal', 'PaypleController@paypal')->name('user.paypal');
// Route::get('/paypal/success', 'PaypleController@success')->name('user.paypal.success');
// Route::get('/paypal/fail', 'PaypleController@fail')->name('user.paypal.fail');
//Paypal Page
Route::get('/Debit-Credit-card', 'Admin\ProductController@DebitCreditcard')->name('user.Debit-Credit-card');
//Paypal Page
Route::get('/payoneer', 'Admin\ProductController@payoneer')->name('user.payoneer');
//Paypal Page
Route::get('/bitcoin', 'Admin\ProductController@bitcoin')->name('user.bitcoin');
//Paypal Page
Route::get('/square', 'PaypleController@square')->name('user.square');
// Route::get('/paypal/success', 'PaypleController@success')->name('user.paypal.success');
//Paypal Page
Route::get('/tranwise', 'Admin\ProductController@tranwise')->name('user.tranwise');
...
Route::post('/get-product-price', 'Admin\ProductController@getProductPrice')->name('get_price');
