...
<section id="cart_items">
    ...
    @endforeach
	 ...
	 <div class="payment-options">
				...
				<span>
					<label><input type="radio" name="payment_method" id="Payoneer" value="Payoneer"><strong> Payoneer</strong></label>
				</span>
				<span>
					<label><input type="radio" name="payment_method" id="Bitcoin" value="Bitcoin"><strong> Bitcoin</strong></label>
				</span>
				<span>
					<label><input type="radio" name="payment_method" id="Debit-credit" value="Debit-credit"><strong> Debit/ Credit card</strong></label>
				</span>
				<span>
					<label><input type="radio" name="payment_method" id="Transwise" value="Transwise"><strong> Transwise</strong></label>
				</span>
				<span>
					<label><input type="radio" name="payment_method" id="Square" value="Square"><strong> Square</strong></label>
				</span>
